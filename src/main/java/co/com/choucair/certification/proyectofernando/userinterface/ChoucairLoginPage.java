package co.com.choucair.certification.proyectofernando.userinterface;
...
public class ChoucairLoginPage extends PageObject {
    ...
    public static final Target INPUT_PASSWORD = Target.the("here do we write the password").located(By.id("password"));
